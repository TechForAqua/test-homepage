    ...
    >
      <div className="flex flex-col justify-center py-4 sm:py-6 px-4 sm:px-6 lg:px-8 max-w-screen-xl mx-auto gap-6 sm:gap-8">
        ...
        <div className="mt-6 sm:mt-8 md:mt-16">
          {/* Center the two cards and keep it responsive */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 sm:gap-x-6 gap-y-8 sm:gap-y-12 max-w-4xl mx-auto justify-items-center">
            {members.map((member, index) => (
              <div key={member.name} className="group overflow-hidden w-full max-w-sm">
                <Image
                  className="h-64 sm:h-80 md:h-96 w-full rounded-md object-cover object-top grayscale transition-all duration-500 hover:grayscale-0"
